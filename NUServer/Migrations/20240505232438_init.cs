        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublishToken = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Packages_AspNetUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackageVersions", x => new { x.PackageId, x.Version });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "PackageVersionDependencyGroups",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    PackageId = table.Column<Guid>(type: "uuid", nullable: false),
                    Version = table.Column<string>(type: "text", nullable: false),
                    PackageVersionPackageId = table.Column<Guid>(type: "uuid", nullable: true),
                    PackageVersionVersion = table.Column<string>(type: "text", nullable: true),
                    TargetFramework = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackageVersionDependencyGroups", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_PackageVersionDependencyGroups_Packages_PackageId",
                        column: x => x.PackageId,
                        principalTable: "Packages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "PackageVersionDependencies",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackageVersionDependencies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PackageVersionDependencies_PackageVersionDependencyGroups_G~",
                        column: x => x.GroupId,
                        principalTable: "PackageVersionDependencyGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackageVersionDependencies_GroupId",
                table: "PackageVersionDependencies",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_PackageVersionDependencyGroups_PackageId",
                table: "PackageVersionDependencyGroups",
                column: "PackageId");

            migrationBuilder.CreateIndex(
                name: "IX_PackageVersionDependencyGroups_PackageVersionPackageId_Pack~",
                table: "PackageVersionDependencyGroups",
